...
extension Bundle
{
    ...
    */
    private var objectForInfoDictionaryKeyPathCache: [String: Any?] {
        get {
            return getAssociatedObject(owner: self, key: &NSBundleObjectForInfoDictionaryKeyPathCache, initialiser: { () -> NSDictionary in [String: AnyObject]() as NSDictionary }) as! [String: AnyObject]
        }
        set {
            setAssociatedObject(owner: self, key: &NSBundleObjectForInfoDictionaryKeyPathCache, value: newValue as NSDictionary)
        }
    }
